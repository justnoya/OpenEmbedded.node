...
function SeparatorNodeComponent({ id, data }: NodeProps) {
  ...
  return (
    <NodeWrapper id={id} typeName="Separator · 14" icon={<SeparatorHorizontal size={18} />} accentColor="#6b7280">
      ...
      <Handle type="source" position={Position.Right} style={{ background: "#6b7280", border: "2px solid #252525", width: 12, height: 12 }} />
    </NodeWrapper>
  );
}
